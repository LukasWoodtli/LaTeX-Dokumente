...
\subsection{Vorsätze von dezimalen Vielfachen (SI)}
\label{sec:VorsätzeVonDezimalenVielfachenSI}
...
\begin{table}[h]
	\begin{tabular}[t]{l l}
		Elementarladung:	&		$e=1,602\cdot10^{-19}\; C$	\\
		Dielektrizitätskonstante:	&	$\epsilon_0=8.8542 \cdot 10^{-12} \; \frac{As}{Vm}$ \\
		Permeabilität im Vakkum:	&	$\mu_0 = 4 \pi \cdot 10^{-7} \frac{Vs}{Am}$ \\
	\end{tabular}
	\caption{Physikalische Konstanten}
	\label{tab:PhysikalischeKonstanten}
\end{table}
